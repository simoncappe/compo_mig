...
oxides=['SiO2','MgO','Na2O','Al2O3','CaO']
#do_all('fracture_toughness_100',oxides,'Toughness')
oxides_avec_SO3=['SiO2','MgO','Na2O','Al2O3','CaO','SO3']
#do_all('viscosity_table',oxides_avec_SO3, 'Viscocity')
#do_all('density_table',oxides,'Density')
#do_all('liquidus_table_95',oxides,'Liquidus')
ox=['SiO2','Al2O3','MgO','CaO','Na2O','K2O','SO3']
#do_all('tenacite',ox,'Fracture Toughness')
#do_all('ym_table',ox,'Young')
do_all('poisson_table',ox,'Poisson Ratio')